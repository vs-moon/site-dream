...
<template>
  <section class="permission-details">
    <CustomizeUpPageView
        v-model="modelValue"
        :confine-attribute="[ 'app' ]"
        :remote-insert="permissionFetch.insertOne"
        :remote-update="permissionFetch.updateOne"
        :remote-query="permissionFetch.selectOne"
        :vm
        :id>
