...
<template>
  <section class="resource-org-manage">
    <CustomizeUpPageManage
        :condition="condition"
        :confine-props="{ app: condition.app }"
        :confine-attribute="[ 'app' ]"
        :remote-query="orgFetch.selectPage"
        :remote-valid="orgFetch.validOne"
        :remote-remove="orgFetch.deleteOne"
        :remote-lazy="orgFetch.selectLazy"
        :lazy>
      <template #default>
