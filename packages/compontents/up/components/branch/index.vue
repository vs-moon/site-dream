...
import { VALID } from '@vs-common/utils/const/enum.js'
    ...
    <template #header>
      <div>
        ...
        <ElInput
            ...
            clearable>
          <template #prepend>
            <ElTooltip v-if="!editable" content="提交选项">
              <ElButton v-if="!editable" link type="primary" @click.stop="onSubmit"
          ...
          <span v-if="editable">
            ...
            <template v-else>
              <ElSwitch
                  ...
                  :disabled="node.parent.data[validKey] === VALID.F"
                  :active-value="VALID.T"
                  :inactive-value="VALID.F"
